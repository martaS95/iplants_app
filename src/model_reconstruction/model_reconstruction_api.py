...
if __name__ == '__main__':
    ...
    # cls.add_enzymes_to_model_db()
    # cls.add_enzymes_to_model_db()
    # cls.add_comparts_to_model_db()
    # cls.create_model_in_database()
    # cls.run_diamond()
    # cls.get_model_elems()
    # cls.add_info_to_model_db()

    # cls.create_all_biomass_reactions()
    # cls.create_main_drains()
    ...
    # cls.add_gprs_to_model_db()

    # cls.get_compartments()
    # cls.add_comparts_to_model_db()

    # cls.run_transyt()

    # cls.add_transporters()

    # cls.export_sbml()

    # cls.create_model_doc()
    # cls.get_gene_locus()
    # cls.run_diamond()
    # cls.get_enzymes_in_model()
    # cls.get_reacs_from_enzymes()
    #
    # to_delete = pd.read_csv(os.path.join(PROJECT_PATH, 'reconstruction_results', modelid, 'results_diamond',
    #                         'reactions_to_delete.csv'))
    #
    # to_delete_list = to_delete['delete reactions'].to_list()
    #
    # to_add = pd.read_csv(os.path.join(PROJECT_PATH, 'reconstruction_results', modelid, 'results_diamond',
    #                      'reactions_to_add.csv'))
    #
    # to_add_list = to_add['reactions add'].to_list()
    #
    # final_reactions = []
    #
    # for reac in cls.reactions:
    #     if reac not in to_delete_list:
    ...
    # cls.get_paths_from_reactions()

    # cls.add_info_to_model_db()

    # cls.get_gene_locus()

    # cls.add_genes_to_model_db()
